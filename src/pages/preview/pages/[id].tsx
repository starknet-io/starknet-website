...
import getContent from '../getContent'; // Import the function to get content by ID
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    ...
    const pageData = await getContent(id); // Replace this with the appropriate function to get content by ID in your project
