...
export const PromoBlock = ({ seo }: Props) => {
  return (
    <Box
      ...
      mb={{
        base: "calc(clamp(220px, 40vw, 320px) * -1)",
        sm: "calc(clamp(150px, 20vw, 200px) * -1)",
        md: "calc(clamp(40px, 15vw, 80px) * -1)",
        xl: "calc(clamp(50px, 15vw, 100px) * -1)",
      }}
    >
      <Box
        sx={{
        ...
        >
          <Heading
            ...
            sx={{
              ...
              mb: "24px",
              borderTop:
                "1px solid var(--static-white-9, rgba(255, 255, 255, 0.44))",
              borderBottom:
                "1px solid var(--static-white-9, rgba(255, 255, 255, 0.44))",
            }}
          >
            ...
            <Box>
              Summit{" "}
              <Box sx={{ display: "inline-block", fontWeight: 700 }}>2023</Box>
            </Box>
          </Heading>
          <Flex
          ...
          >
            ...
            <Button
              ...
              size="md"
              bg="#d48c87"
              sx={{ borderColor: "white", color: "white", minWidth: "200px" }}
            >
              Get Tickets
            </Button>
          </Flex>
