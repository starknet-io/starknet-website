...
const OnrampIcon: React.FC<CardIconProps> = ({ gradientColor1, gradientColor2, filter, borderRadius }) => {
  ...
  return (
    <svg filter={filter} border-radius={borderRadius} xmlns="http://www.w3.org/2000/svg" width="104" height="104" viewBox="0 0 104 104" fill="none">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M1.39876e-06 67C1.51947e-06 64.2386 2.23858 62 5 62H37C39.7614 62 42 64.2386 42 67L42 99C42 101.761 39.7614 104 37 104H5C2.23858 104 -1.20706e-07 101.761 0 99L1.39876e-06 67ZM5 64C3.34315 64 2 65.3432 2 67L2 99C2 100.657 3.34315 102 5 102H37C38.6569 102 40 100.657 40 99L40 67C40 65.3431 38.6569 64 37 64H5Z" fill={`url(#${`${gradientIdPrefix}-paint0_linear`})`}/>
