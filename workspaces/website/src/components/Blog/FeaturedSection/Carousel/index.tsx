...
export const Carousel: React.FunctionComponent<CarouselProps> = ({
  ...
  const [interval, setInterval] = useState<number|null>(4000);
  const isMobile = useBreakpointValue({ base: true, lg: false })
  const isExtraSmall = useBreakpointValue({ base: true, sm: false })
  ...
  return (
    <>
      <motion.div 
        ...
        style={{
          position: 'relative',
          width: !isExtraSmall ? '456px' : 'calc(100% - 12px)',
          height: isExtraSmall ? '472px' :'543px',
          overflowX: 'visible'
        }}
      >
