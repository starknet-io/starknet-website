...
export const CategoryButton = ({
  ...
  return (
    <>
      <Button
        isActive={!(openCategory === category.slug) && (category.children.some((child) => child.slug === activeCategory) || activeCategory === category.slug)}
        display={'flex'}
      ...
      <Collapse in={openCategory === category.slug}>
